 ...
 *
 * On Android, when the preference `AndroidEdgeToEdge` is `true`, this may not produce
 * a visible status bar background fill, but can still be used to set the
 * light/dark status bar appearance.
 *
