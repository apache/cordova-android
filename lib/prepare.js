...
function updateProjectSplashScreen (platformConfig, locations) {
    ...
    [
        ...
        const cdvConfigPrefKeys = 'Android' + themeKey.charAt(0).toUpperCase() + themeKey.slice(1);
        const cdvConfigPrefValue = platformConfig.getPreference(cdvConfigPrefKeys, this.platform);
