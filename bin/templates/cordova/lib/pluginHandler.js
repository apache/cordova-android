...
var common = require('./pluginHandlerCommon');
var xml_helpers = require('./xmlHelper');
var CordovaError = require('./CordovaError');
var android_project = require('./androidProject');
...
function package_suffix(project_dir) {
    var packageName = module.exports.prototype.getPackageName(project_dir);
...
// TODO: overwriting prototype isn't a good idea, update it.
PluginHandler.prototype = {
    ...
    getPackageName:function(project_dir) {
    ...
    'framework': {
        install:function(obj, plugin_dir, project_dir, plugin_id, options) {
            ...
            var projectConfig = PluginHandler.prototype.parseProjectFile(project_dir);
