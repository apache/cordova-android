...
describe('ProjectBuilder', () => {
    ...
    describe('clean', () => {
        ...
        it('should remove "out" folder', () => {
            return builder.clean({}).then(() => {
                expect(removeSyncSpy).toHaveBeenCalledWith(path.join(rootDir, 'out'));
            });
        });
        ...
        it('should remove signing files if they are autogenerated', () => {
            ...
            return builder.clean({}).then(() => {
                expect(removeSyncSpy).toHaveBeenCalledWith(debugSigningFile);
                expect(removeSyncSpy).toHaveBeenCalledWith(releaseSigningFile);
            });
        });
        ...
        it('should not remove signing files if they are not autogenerated', () => {
            ...
            return builder.clean({}).then(() => {
                expect(removeSyncSpy).not.toHaveBeenCalledWith(debugSigningFile);
                expect(removeSyncSpy).not.toHaveBeenCalledWith(releaseSigningFile);
            });
        });
    });
    ...
    describe('isAutoGenerated', () => {
        ...
        it('should return true if the file contains the autogenerated marker', () => {
            ...
            spyOn(fs, 'readFileSync').and.returnValue(fileContents);
