...
public class AudioPlayer implements OnCompletionListener, OnPreparedListener, OnErrorListener {
	...
	public void startRecording(String file) {
		if (this.mPlayer != null) {
			...
			this.handler.sendJavascript("Media.onStatus('" + this.id + "', "+MEDIA_ERROR+", "+MEDIA_ERR_ABORTED+");");
		}
	...
	public void seekToPlaying(int milliseconds) {
		if (this.mPlayer != null) {
		    ...
		    this.handler.sendJavascript("Media.onStatus('" + this.id + "', "+MEDIA_POSITION+", "+milliseconds/1000.0f+");");
		}
	}
	...
	public void pausePlaying() {
		...
		if (this.state == MEDIA_RUNNING) {
			...
			this.handler.sendJavascript("Media.onStatus('" + this.id + "', "+MEDIA_ERROR+", "+MEDIA_ERR_NONE_ACTIVE+");");			
		}
	}
	...
	public long getCurrentPosition() {
		if ((this.state == MEDIA_RUNNING) || (this.state == MEDIA_PAUSED)) {
		    ...
		    this.handler.sendJavascript("Media.onStatus('" + this.id + "', "+MEDIA_POSITION+", "+curPos/1000.0f+");");
			return curPos;
		} 
		else { 
			return -1; 
   ...
   /**
	...
	public void onPrepared(MediaPlayer mPlayer) {
		...
		this.handler.sendJavascript("Media.onStatus('" + this.id + "', "+MEDIA_DURATION+","+this.duration+");");
	...
	public boolean onError(MediaPlayer mPlayer, int arg1, int arg2) {
		...
		this.handler.sendJavascript("Media.onStatus('" + this.id + "', "+MEDIA_ERROR+", "+arg1+");");
		return false;
	}
	...
	private void setState(int state) {
		if (this.state != state) {
			this.handler.sendJavascript("Media.onStatus('" + this.id + "', "+MEDIA_STATE+", "+state+");");
		}
